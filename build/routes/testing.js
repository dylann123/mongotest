...
router.get("/cleardatabase", function (req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.default.getMongoClient()];
                case 1:
                    client = _a.sent();
...
router.get("/removecollection", function (req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
...
router.get("/clearcollection", function (req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var collection, client;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
router.get("/getdatabaseitems", function (req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var client, array;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    client = _a.sent();
                    return [4 /*yield*/, client.db(DATABASE_NAME).listCollections().toArray()];
                case 2:
                    array = _a.sent();
...
router.get("/getcollectionitems", function (req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var collection, client, array;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    collection = req.query.collection;
